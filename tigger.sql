...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-08-2024 a las 13:34:12
...
--
-- Base de datos: `tigger`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `audi_medico`
--

CREATE TABLE `audi_medico` (
...
--
-- Indices de la tabla `audi_medico`
--
ALTER TABLE `audi_medico`
...
--
-- AUTO_INCREMENT de la tabla `audi_medico`
--
ALTER TABLE `audi_medico`
